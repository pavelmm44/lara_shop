            ...
            <div class="grow flex flex-col lg:py-8">
                ...
                <form action="{{ route('cart.add', $product) }}" method="POST" class="space-y-8 mt-8">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 2xl:grid-cols-4 gap-4">
                        @foreach($options as $option => $values)
                            <div class="flex flex-col gap-2">
                                <label for="filter-item-2" class="cursor-pointer text-body text-xxs font-medium">
                                    {{ $option }}
                                </label>
                                <select name="options[]" id="filter-item-2" class="form-select w-full h-12 px-4 rounded-lg border border-body/10 focus:border-pink focus:shadow-[0_0_0_3px_#EC4176] bg-white/5 text-white text-xs shadow-transparent outline-0 transition">
                    ...
                    <div class="flex flex-wrap items-center gap-3 xs:gap-4">
                        ...
                        <a href="#" class="w-[68px] !px-0 btn btn-purple" title="Add to favorites">
