            ...
            <div class="basis-auto xl:basis-3/4">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                    ...
                    <div x-data="{sort: '{{ filter_url($category, ['sort' => request('sort')]) }}'}" class="flex flex-col sm:flex-row sm:items-center gap-3">
                        ...
                        >
                            <option value="{{ filter_url($category, ['sort' => '']) }}" class="text-dark">default</option>

                            <option value="{{ filter_url($category, ['sort' => 'price']) }}" class="text-dark">from
                                cheap to expensive
                            </option>
                            ...
                            <option value="{{ filter_url($category, ['sort' => 'title']) }}" class="text-dark">title
                            </option>
                        </select>
